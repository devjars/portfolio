...
function Header() {
  return (
    <header className="w-full flex gap-4 flex-row">
      <div className="w-full flex justify-center xl:w-[45%]">
        <img
          src={profile}
          alt="John Anthony Solana's Profile Picture"
          className="w-full max-w-[300px] max-h-[300px] object-cover rounded-2xl"
          loading="eager" 
        />
      </div>
  ...
  <a href="/RESUME-JohnAnthonySolana.pdf" download className="btn btn-primary btn-xs s:btn-sm">
    Resume
    <FcDownload />
  </a>
</div>
